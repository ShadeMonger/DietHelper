...
public class MyInfoActivity extends AppCompatActivity {
    ...
    CheckBox dis1, dis2, dis3, dis4, dis5, dis6;
    Button update;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dis5 = (CheckBox) findViewById(R.id.dis5);
        dis6 = (CheckBox) findViewById(R.id.dis6);
        ...
        if (u != null) {
            ...
            if (u.dis5)
                dis5.setChecked(true);
            if (u.dis6)
                dis6.setChecked(true);
        }
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                u.dis5 = dis5.isChecked();
                u.dis6 = dis6.isChecked();
                u.save();
        ...
        alert11.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!oldPass.getText().toString().contentEquals(u.password)) {
                    ...
                    Toast.makeText(MyInfoActivity.this, "Incorrect password!", Toast.LENGTH_SHORT).show();
                    return;
                    ...
                    if (newPass.getText().toString().length() < 6) {
                        ...
                        if (!newPass.getText().toString().contentEquals(confirmPass.getText().toString())) {
                            Toast.makeText(MyInfoActivity.this, "Password is not same!", Toast.LENGTH_SHORT).show();
                            return;
                        } else {
